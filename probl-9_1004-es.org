...
\PMeL$. ¿Qué relación existirá entre el coste medio y el coste
...
decidir qué cantidad de factores debe de contratar a largo plazo si se
producen 150 unidades y los precios unitarios del trabajo y del capital
...
\price{80}$. Inicialmente, la empresa produce 100 unidades utilizando
20 unidades de trabajo y 5 unidades de capital.

a) ¿Está minimizando costes la empresa? Si su respuesta es negativa,
   determine las cantidades óptimas de trabajo y capital.
b) <<ex9.21:item-b>>Si la empresa aumentara su producción a 140 unidades
   y el capital fuera fijo, ¿cuánto aumentarían los costes de producción?
c) <<ex9.21:item-c>>Si la empresa aumentara su producción a 140
   unidades y todos los factores fueran variables, ¿cuánto aumentarían
   los costes de producción?
d) Compare las respuestas obtenidas en los apartados [[ex9.21:item-b]] y
   [[ex9.21:item-c]]. ¿Por qué son diferentes?

* 9.22

Considere una empresa que produce una cantidad para la que se igualan
los costes de corto plazo y los de largo plazo. Si se produce un
aumento del salario de un 5%, ¿cómo cambiarán los costes variables
medios? ¿Y los costes medios a corto plazo? ¿Y los
