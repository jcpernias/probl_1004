...
1. Medicines have inelastic demand, while computers have elastic
...
2. When the government of a country increased the cigarette tax, the
...
3. Two drivers pull up to the same gas station every Monday and place
...
4. Anna pays \money{2} for each unit of food, spends \money{5000} per
...
5. The market for good $X$ is characterized by the demand and supply
   functions:
   #+begin_export latex
   \begin{gather*}
...
6. The firm that operates a road tunnel is considering lowering the
