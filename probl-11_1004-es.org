...
a) Todas las combinaciones de factores sobre una isocoste representan
   ...
   cuestan $40 \cdot 12 = \money{480}$. Dividiendo por el salario
...
a) La minimización de los costes requiere:
   ...
   #+end_export
   Esta condición se puede simplificar como: $K =
   L$.  Sustituyendo en la función de producción y
   operando, se llega a la demanda condicional de trabajo: $L(Q) =
   Q^{1/3}$ y a la demanda condicional de capital: $K(Q) = Q^{1/3}$.

b) El coste total es: $\CT = 16 L + 8 K$.  Sustituyendo en esta
   expresión las demandas condicionales y operando se obtienen los
...
c) En general, los costes a corto plazo son mayores que los costes a
   ...
   Sólo cuando $Q = 9$, el capital a corto plazo coincide con el nivel
...
b) A largo plazo, la empresa seleccionaría aquellas cestas donde la
   ...
   nuestro caso, esto ocurre cuando $K=4$, $L=$ y $Q = 160$.
