...
Todos los consumidores compran al menos una unidad de los dos bienes:
la relación marginal de sustitución de cada consumidor se iguala a los
precios relativos. Por otro lado, al ser competitiva la economía,
todos los consumidores pagan los mismos precios. Por tanto:
#+begin_export latex
\[
...
b) /Subvención/: la restricción presupuestaria tiene dos tramos. Si el
   ...
   óptima ya que no es compatible nuestro supuesto inicial $N >
   \units[kg]{1.500}$.
