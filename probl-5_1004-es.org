...
a) Representado los minutos de llamadas telefónicas por $T$ y el bien
...
c) Comparando las dos tarifas, se concluye que Ángeles debería
   contratar la tarifa del apartado [[ex5.25:itemb]] si $750 \leq T \leq
   \num{3250}$. La otra tarifa sólo sería más conveniente si Ángeles
   no dedica mucho tiempo a llamadas telefónicas, $T < 750$, o, por el
   contrario, si piensa utilizar mucho el teléfono, $T > \num{3250}$.
