...
#+begin_src latex :tangle fig-probl-4_1004-ex1-budget.tex
...
#+begin_src latex :tangle fig-probl-4_1004-ex1-opt.tex
  \begin{tikzpicture}<<ex1:xy-scale>>
    <<ex1:endowment-help-lines>>
...
#+begin_src latex :tangle fig-probl-4_1004-ex2-budget.tex :noweb no
...
#+begin_src latex :tangle fig-probl-4_1004-ex3-r10.tex :noweb no
...
#+begin_src latex :tangle fig-probl-4_1004-ex3-r5.tex :noweb no
  \begin{tikzpicture}[xscale = 0.4, yscale = 0.4,
    use Hobby shortcut,
    tangent/.style={
      in angle={(180+#1)},
...
#+begin_src latex :tangle fig-probl-4_1004-ex4-budget.tex
...
#+begin_src latex :tangle fig-probl-4_1004-ex4-lender.tex
  \begin{tikzpicture}<<ex4:xy-scale>>
    <<ex4:budget-line>>
...
#+begin_src latex :tangle fig-probl-4_1004-ex4-borrower.tex
  \begin{tikzpicture}<<ex4:xy-scale>>
    <<ex4:budget-line>>
...
#+begin_src latex :tangle fig-probl-4_1004-ex4-flat-budget.tex
...
#+begin_src latex :tangle fig-probl-4_1004-ex4-flat-choice.tex
  \begin{tikzpicture}<<ex4:xy-scale>>
    \begin{scope}[nearly transparent]
      <<ex4:budget-line>>
    \end{scope}
...
#+begin_src latex :tangle fig-probl-4_1004-ex5-budget.tex
...
#+begin_src latex :tangle fig-probl-4_1004-ex5-opt.tex
  \begin{tikzpicture}<<ex5:xy-scale>>
    <<ex5:endowment-help-lines>>
...
#+begin_src latex :tangle fig-probl-4_1004-ex6-budget.tex :noweb no
