...
d) La curva de demanda después del impuesto es:
   ...
   vendedores ingresan \money{950} por unidad; los compradores pagan
...
a) En equilibrio el alquiler mensual asciende a $P^* = \money{500}$ y
   se alquilan $Q^* = \num{10000}$ viviendas.
...
b) Cuando se introduce la subvención la curva de demanda es:
   ...
   \num{11500}$ viviendas: los caseros reciben \money{650} y los
   inquilinos pagan \money{450} por vivienda. El coste total de las
   subvenciones es de $200 \times \num{11500} = \money{2300000}$.
