...
El siguiente gráfico muestra las curvas de demanda y de oferta de un mercado competitivo:

#+xxx: fig fig-probl-4_1004-price-controls-*.pdf

Calcule la cantidad que se vendería y a qué precio en cada una de las siguientes situaciones:
...
b) El ayuntamiento establece un programa de ayudas al alquiler por el
   ...
   mes. ¿Cómo afectará este programa al alquiler mensual que cobran los
   caseros? Represente gráficamente. ¿Cómo cambiará la cantidad que
   paga cada inquilino por el alquiler? ¿Cuál será el coste total del
   programa de subvenciones para el ayuntamiento?
