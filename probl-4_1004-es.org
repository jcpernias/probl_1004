...
b) La curva de oferta después del impuesto es:
   ...
   \]
   #+end_export
   En el nuevo equilibrio: $P^* = \price{1100}$ y $Q^* =
   \units{78000}$.
   #+xxx: fig fig-ans-probl-4_1004-tax-sellers-*.pdf

   Los compradores pagan \money{1100} por unidad; \money{100} más que
   antes del impuesto. Una vez descontado el impuesto los vendedores
   ingresan \money{950} por unidad; \money{50} menos que en la
   situación inicial.
...
d) La curva de demanda después del impuesto es:
   ...
   \]
   #+end_export
   Después de la introducción del impuesto a los compradores, el
   precio es $P^* = \price{950}$ y la cantidad es $Q^* =
   \units{78000}$.
   #+xxx: fig fig-ans-probl-4_1004-tax-buyers-*.pdf

   Los resultados son idénticos a los del apartado
   [[ex4.7:item-b]]. Mientras que los vendedores ingresan \money{950} por
   unidad, los compradores pagan el precio más el impuesto: un total
   de \money{1100} por unidad.
...
a) Igualando oferta y demanda se obtiene el equilibrio de mercado: el
   alquiler mensual asciende a $P^* = \money{500}$ y se alquilan $Q^*
   = \num{10000}$ viviendas.
...
b) Cuando se introduce la subvención la curva de demanda es:
   ...
   \]
   #+end_export
   En el nuevo equilibrio $P^* = \money{650}$ al mes y $Q^* =
   \num{11500}$ viviendas.
   #+xxx: fig fig-ans-probl-4_1004-subsidy2-*.pdf

   Por cada vivienda alquilada los caseros reciben \money{650} y los
   inquilinos pagan \money{450}. El coste total del programa de
   subvenciones asciende a $200 \times \num{11500} = \money{2300000}$.
