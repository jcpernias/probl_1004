...
1. In a competitive market, the demand and supply curves are:
   #+begin_export latex
   \begin{gather*}
     Q^d = \num{100000} - 20 P \\
     Q^o = \num{40000} + 40 P
...
2. The market demand and supply curves for good $X$ are:
   #+begin_export latex
   \begin{gather*}
     X^d = 100 - P_X / 40 \\
     X^o = 50 + P_X / 40
...
3. In a competitive market in equilibrium, \num{96000} units are sold
...
4. The market demand and supply curves for good $X$ are:
   #+begin_export latex
   \begin{gather*}
...
5. Discuss the truth or falsity of the following statement: "If a
   maximum price is set above the equilibrium price, the quantity
   sold will be the same as the equilibrium quantity."

6. The residential rental market in a city is represented by the
