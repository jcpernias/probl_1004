...
a) Restricción intertemporal:
   ...
   #+xxx: fig file:fig-ans-probl-7_1004-ex1-budget-*.pdf
...
b) Condición de tangencia:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-7_1004-ex1-opt-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-7_1004-ex2-budget-*.pdf
#+ATTR_LATEX: :options [t]{0.45\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-7_1004-ex3-r10-*.pdf
#+ATTR_LATEX: :options [t]{0.45\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-7_1004-ex3-r5-*.pdf
#+ATTR_LATEX: :options [t]{0.45\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
a) La restricción intertemporal tiene dos tramos con pendientes
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-7_1004-ex4-budget-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b) Calculamos la solución que se obtendría en cada caso:
   ...
   - El consumidor presta: $C_1 \leq 200$.
     ...
     #+latex: \vspace{0pt}
     #+ATTR_LATEX: :center nil
     #+xxx: fig file:fig-ans-probl-7_1004-ex4-lender-*.pdf
     #+ATTR_LATEX: :options [t]{0.45\linewidth}
     #+xxx: col
     #+latex: \vspace{1ex}
     Resolviendo:
   ...
   - El consumidor pide prestado: $C_1 \geq 200$.
     ...
     #+latex: \vspace{0pt}
     #+ATTR_LATEX: :center nil
     #+xxx: fig file:fig-ans-probl-7_1004-ex4-borrower-*.pdf
     #+ATTR_LATEX: :options [t]{0.45\linewidth}
     #+xxx: col
     #+latex: \vspace{1ex}
     Resolviendo:
...
c) Restricción intertemporal: $C_2 = 436 - 1.08 C_2$.
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-7_1004-ex4-flat-budget-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-7_1004-ex4-flat-choice-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Elección óptima:
...
a)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-7_1004-ex5-budget-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Restricción intertemporal:
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-7_1004-ex5-opt-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Elección óptima:
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-7_1004-ex6-budget-*.pdf
#+ATTR_LATEX: :options [t]{0.45\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
Restricción intertemporal:
