...
7. A consumer has an income of \money{40} that she spends on goods $X$
   and $Y$, whose prices are $P_X = \price{3}$ and $P_Y =
   \price{2}$. When she consumes $20$ units of $Y$ and none of $X$,
   the marginal rate of substitution is equal to $2$. Is this the
...
9. A consumer has an income of \money{800} to buy goods $X$ and $Y$,
   ...
   b) If a price discount of \money{2} were applied to each unit of
      $X$ beyond the first 75, how would the optimal choice change?

10. The preferences of a consumer are given by the utility function:
    $U(X, Y) = X (Y + 100)$. The price of the good $X$ is \price{1}
    and that of the good $Y$ is \price{4}. The consumer has a monetary
    income of \money{250}.

    a) Calculate the optimal consumption bundle.

    b) If the good $X$ were rationed so that the consumer were not
       allowed to buy more than 100 units of $X$, what would be the
       optimal choice?  Represent graphically.
...
11. The utility function of an individual with respect to the goods
    ...
    c) How would the optimal choice change if $P_X =
       \price{10}$?

12. Rocío likes to eat cereal with milk. She always combines them in
    the same proportion: she adds exactly 20 grams of cereal per every
    \units[ml]{250} of milk and discards any excess of milk or cereal.
