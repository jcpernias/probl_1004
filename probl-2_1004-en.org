...
2. A consumer has \money{20} to buy meat and potatoes. He usually
   shops at a supermarket where the meat is sold for \money{4} per
   kilo, and one kilo of potatoes costs \money{2}.

   a) Obtain and represent the budget constraint.

   b) The supermarket run a sales promotion where customers that buy
      more than \units[kg]{4} of potatoes will get two additional
...
5. The optimal basket of a consumer with regular preferences contains
   ...
   increased, would this reduce the consumer's utility? Justify your
   answer.
...
8. The function $U (N, Y) = (N + 4) Y$ describes the preferences of a
   ...
   b) The Government wants to promote the consumption of nuts and it
      is studying different alternatives:

      + A subsidy that reduces the price of nuts by 20%. The subsidy
        can only be applied to one and a half kilograms of nuts per
        consumer.
