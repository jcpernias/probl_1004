...
$A$. Supongamos que cuando aumenta la renta elige otra cesta, $B$, con
menos unidades de todos los bienes. Esta cesta la pudo haber comprado
con la renta inicial pero no lo hizo: el consumidor prefiere $A$ a
$B$. Finalmente, después del aumento de renta tanto $A$ como $B$ son
accesibles; pudiendo comprar $A$ nunca elegiría una cesta como la $B$.
