...
a) La curva de demanda de mercado se obtiene sumando las curvas de
   ...
   demandas individuales, ya que medimos la cantidad demandada en el
   eje horizontal y el precio en el vertical.
...
b) La elasticidad de una curva de demanda individual es:
   ...
   \]
   #+end_export
   Por tanto, coinciden las elasticidades de la demanda de mercado y
...
En el caso de Adela, el bien $Y$ es neutro: la utilidad de Adela es
insensible al consumo de $Y$ y sólo varía si se altera el consumo de
$X$.
...
En estas condiciones Blas gastaría toda su renta en el bien que tenga
...
\]
#+end_export
Utilizando las dos últimas ecuaciones podemos obtener la curva de
demanda de cereales:
#+begin_export latex
\[
  C(P_C) = \frac{6}{10 + P_C}
...
a) La elección inicial de Stephanie se obtiene resolviendo las
   ...
   La elección óptima antes de la introducción del impuesto es: $R_1 =
   76$ latas e $Y_1 = \money{432}$.

b) La introducción del impuesto modifica el precio de las latas de
   refresco. Las nuevas condiciones de óptimo son:

   - Recta presupuestaria: $470 = R + Y$.

   - Condición de tangencia: $(1/9) Y/(R + 20) = 1$.

   Cuando se introduce el impuesto, la elección óptima de Stephanie es:
   $R_2 = 29$ latas e $Y_2 = \money{441}$. Por tanto, pagará en
   concepto de impuestos: $R_2 t = 29 \times 0.5 = \money{14.5}$.

c) Cuando se complementa el impuesto con la donación en metálico de
   \money{14.50}, las condiciones de óptimo serían:

   - Recta presupuestaria: $484.5 = R + Y$.

   - Condición de tangencia: $(1/9) Y/(R + 20) = 1$.

   Resolviendo estas dos ecuaciones se obtiene la elección óptima:
   $R_3 = 30.45$ latas e $Y_3 = \money{454.05}$. Stephanie pagará
   ahora en concepto de impuestos: $R_3 t = 30.45 \times 0.5 =
   \money{15.225}$.
   ...
   - La donación en metálico es inferior a la recaudación del impuesto
     por consumidor, por lo que no harían falta fuentes adicionales de
     financiación.
