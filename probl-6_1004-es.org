...
2. Complete la siguiente tabla que representa los costes a corto plazo
   de una empresa.
...
4. La propietaria de una empresa ha dibujado el siguiente gráfico para
   decidir qué cantidad de factores que debe de contratar a largo
   ...
   a) Complete el gráfico etiquetando las intersecciones de las
   ...
   b) Si la empresa produce 150 unidades y sus costes son de
      \money{440}, ¿se están minimizando los costes?
...
5. Sauron SA es una empresa dedicada a la producción de anillos
   exclusivos empleando trabajadores e impresoras 3D. En la situación
   actual, la producción diaria se incrementaría en 18 anillos si se
   contratara un trabajador más. Si en vez de aumentar la plantilla se
   alquilara una impresora adicional, la producción diaria se elevaría
   en 6 anillos. Sabiendo que el salario al día es 4 veces el alquiler
   diario de una impresora 3D, ¿está minimizando Sauron SA sus costes?
   Si su respuesta es negativa, ¿qué podría hacer Sauron SA para
   reducir sus costes? Justifique sus respuestas.
...
6. Una empresa tiene la función de producción: $Q = L^{3/2}
...
7. La función de producción de una empresa es: $F(L, K) = L^{2}
   K$. Los precios de los factores son: $w = \wage{16}$ y $r =
   \price{8}$.
...
8. La curva de costes totales a largo plazo de un empresa es:
   ...
   producción existen economías de escala? ¿Y deseconomías de escala?
...
9. Una empresa opera con la tecnología $Q = K L$ y usa 3 unidades de
   capital a corto plazo. Los precios de los factores son $w=
   \wage{1}$ y $r=\price{1}$.

   a) ¿Cuál es la curva de costes a corto plazo?
   ...
   b) ¿Cuál es el único nivel de producción en el que coinciden los
      ...
      ocurre en cualquier otro nivel de producción? Represente
      gráficamente.
...
10. La figura siguiente muestra algunas isocuantas de la función de
    ...
    b) Calcule los costes a largo plazo de producir $40$, $160$ y
       $360$ unidades. ¿Coincide en algún caso los costes a corto y a
       largo plazo?
...
11. Explique y justifique si considera correcta o incorrecta cada una
    ...
    a) El coste medio se maximiza cuando coincide con el coste
       marginal.
    ...
    c) A largo plazo y si el coste marginal es superior al coste
       medio, la empresa está operando con rendimientos crecientes de
       escala.
...
12. Una pequeña empresa dedicada a la producción de guitarras
    eléctricas está planteándose la posibilidad de utilizar un taller
    adicional. Los costes medios cuando utiliza un único taller son:
    #+begin_export latex
    \[
      \CMe_1(Q) = 0.01 Q^2 - 6 Q + 1400
    \]
    #+end_export
    donde $Q$ es el número de guitarras que produce al año. Si opera
    con dos talleres su curva de costes medios sería:
    #+begin_export latex
    \[
    ...
    a) Si la empresa espera poder vender 600 guitarras el próximo año,
       ¿debería usar uno o dos talleres?
    ...
    b) Obtenga y represente la curva de costes medios totales a largo
       plazo.
