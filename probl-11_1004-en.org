...
b) <<ex11.21:item-b>>If the firm increased its output to 100 units and
   the capital was fixed, how much would the costs of production
   increase?
c) <<ex11.21:item-c>>If the firm increased its output to 100 units and
   all inputs were variable, how much would the costs of production
   increase?
d) Compare the answers to [[ex11.21:item-b]] and [[ex11.21:item-c]]. Why do they
   differ?
