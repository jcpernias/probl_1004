...
#+begin_src latex :noweb-ref ex1.10:xy-scale
  yscale = 0.01, xscale = 0.01
#+end_src

#+begin_src latex :noweb-ref ex1.10:axes
  \draw[axis, very thick]
    (0, 475) node[above left] {$V$} |-
    (475, 0) node[below right] {$A$} ;
#+end_src

#+begin_src latex :noweb-ref ex1.10:grid
  \draw[help lines]
    (0, 100) node[left] {$100$} -- (415, 100)
    (0, 200) node[left] {$200$} -- (415, 200)
    (0, 300) node[left] {$300$} -- (415, 300)
    (0, 400) node[left] {$400$} -- (415, 400)
    (100, 0) node[below] {$100$} -- (100, 415)
    (200, 0) node[below] {$200$} -- (200, 415)
    (300, 0) node[below] {$300$} -- (300, 415)
...
#+begin_src latex :noweb-ref ex1.2:axes
  \draw[axis, very thick] (0,6) node[above left] {\translate{Cañones}} |-
    (24, 0) node[below right] {\translate{Mantequilla}} ;
#+end_src
...
#+begin_src latex :tangle fig-probl-1_1004-ppf-lin.tex :noweb no
