...
#+begin_src latex :tangle fig-probl-4_1004-before-tax.tex :noweb no
...
#+begin_src latex :tangle fig-probl-4_1004-tax-sellers.tex :noweb no
  \begin{tikzpicture}[xscale=5, yscale=5]
...
#+begin_src latex :tangle fig-probl-4_1004-tax-buyers.tex :noweb no
  \begin{tikzpicture}[xscale=5, yscale=5]
...
#+begin_src latex :tangle fig-probl-4_1004-min-price.tex :noweb no
...
* 4.4 Equilibrium and price ceiling
  ...
  #+begin_src latex :tangle fig-probl-4_1004-eq1.tex :noweb no
  ...
  #+begin_src latex :tangle fig-probl-4_1004-eq2.tex :noweb no
    \begin{tikzpicture}[xscale = 0.75, yscale = 2.28571]
...
#+begin_src latex :tangle fig-probl-4_1004-subsidy1.tex :noweb no
...
#+begin_src latex :tangle fig-probl-4_1004-subsidy2.tex :noweb no
  \begin{tikzpicture}[xscale=3.89, yscale=4.5454545454]
