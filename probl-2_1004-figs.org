...
#+begin_src latex :tangle fig-probl-2_1004-discount1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-corner1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-corner2.tex :noweb yes
  \begin{tikzpicture}<<ex10:xy-scale>>
...
#+begin_src latex :tangle fig-probl-2_1004-compl1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-compl2.tex :noweb yes
  \begin{tikzpicture}<<ex12:xy-scale>>
