...
#+begin_src latex :tangle fig-ans-probl-2_1004-week-days.tex
...
#+begin_src latex :tangle fig-ans-probl-2_1004-weekend.tex
  \begin{tikzpicture}[<<ex2.8:xy-scale>>]
    <<ex2.8:coord-def>>
...
#+begin_src latex :noweb-ref ex2.8:coord-def
  \coordinate (DA1) at (2.0, 2.9) ;
  \coordinate (DB1) at (2.7, 0.6) ;
  \coordinate (DA2) at (0.2, 1.8) ;
...
#+begin_src latex :noweb-ref ex2.8:curve-O1
  \draw[curve, very thick, name path=D1] (OA1) -- (OB1)
  node[right] {$O$} ;
#+end_src
