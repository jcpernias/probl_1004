...
* Market demand
  ...
  #+begin_src latex :tangle fig-probl-2_1004-market-demand.tex
...
* Market equilibrium
  ...
  #+begin_src latex :tangle fig-probl-2_1004-market-eq.tex
...
* Apple market
  ...
  #+begin_src latex :tangle fig-probl-2_1004-apples.tex
...
#+begin_src latex :tangle fig-probl-2_1004-drugs1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-drugs2.tex :noweb yes
  \begin{tikzpicture}<<ex9:xy-scale>>
...
#+begin_src latex :tangle fig-probl-2_1004-comp1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-comp2.tex :noweb yes
  \begin{tikzpicture}<<ex11:xy-scale>>
...
#+begin_src latex :tangle fig-probl-2_1004-comp3.tex :noweb yes
  \begin{tikzpicture}<<ex11:xy-scale>>
...
#+begin_src latex :tangle fig-probl-2_1004-cars1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-cars2.tex :noweb yes
  \begin{tikzpicture}<<ex12:xy-scale>>
...
#+begin_src latex :tangle fig-probl-2_1004-inferior1.tex :noweb yes
...
#+begin_src latex :tangle fig-probl-2_1004-inferior2.tex :noweb yes
  \begin{tikzpicture}<<ex13:xy-scale>>
