...
pendiente de la curva de Engel es positiva cuando el bien es normal
...
a) La elección óptima es la intersección de \CRC y la recta
   presupuestaria correspondiente a $M = \money{70}$. Para trazar esta
   última, se unen los puntos de corte de la recta presupuestaria con
   los ejes: $M / P_X = 70$ en el eje $X$ y $M / P_Y = 70$ en el eje
...
b) Conforme aumenta la renta y la recta presupuestaria se desplaza
   ...
   opuesta a la renta para valores de $M$ más altos. En concreto, el
   bien $Y$ es normal para $M \leq \money{120}$ y es un bien inferior
   para $M > \money{120}$.
...
b) La introducción del impuesto modifica el precio de las latas de
   ...
   Cuando se introduce el impuesto, la elección óptima de Stephanie
   es: $R_2 = 29$ latas e $Y_2 = \money{441}$. Por tanto, pagará en
   concepto del impuesto sobre los refrescos azucarados: $R_2 t = 29
   \times 0.5 = \money{14.5}$.
...
c) Cuando se complementa el impuesto con la donación en metálico de
   ...
   ahora en concepto de impuestos sobre los refrescos azucarados: $R_3
   t = 30.45 \times 0.5 = \money{15.225}$.
