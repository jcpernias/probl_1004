...
c) No es posible determinar qué ocurrirá con el precio y la cantidad
   ...
   Al crecer la renta aumentarán el precio y la cantidad de equilibrio
   si se trata de un bien normal, pero disminuirán el precio y la
   cantidad de equilibrio en el caso de un bien inferior.
...
- En fin de semana la demanda de habitaciones por motivos de turismo y
  ...
  disposición a pagar y buscará destinos alternativos más baratos si
  el precio de las habitaciones es muy elevado.
