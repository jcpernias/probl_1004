...
1. Hay tres compradores en un mercado cuyas curvas de demanda son:
...
2. Considere un mercado competitivo donde participan \num{1000}
...
3. "El precio de la gasolina aumentó considerablemente durante los
...
4. Considere un mercado competitivo de manzanas y trace un diagrama de
...
5. Un país se enfrenta a un aumento del consumo de drogas. Los
...
6. Las curvas de demanda y de oferta del mercado del bien $X$ son:
   #+begin_export latex
   \begin{gather*}
     X^d = \num{85000} - 20 P_X \\
     X^o = \num{15000} + 15 P_X
...
7. El mercado de coches eléctricos de un país es competitivo y las
...
8. El mercado de un bien inferior se encuentra en equilibrio. Si
