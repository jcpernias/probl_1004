...
b) Si el precio de mercado es $P = \price{4}$ se produce un exceso de
   oferta de \num{5000} unidades. Si $P = \price{1}$ se produce un exceso de
   demanda de \num{2500} unidades.
...
b) Si se eleva el precio de un bien sustitutivo, la demanda
...
c) No es posible determinar qué ocurrirá con el precio y la cantidad
   ...
   Si es un bien normal, al crecer la renta aumentarán el precio y la
   cantidad de equilibrio.
   #+xxx: fig fig-ans-probl-2_1004-comp2-*.pdf

   Pero si es un bien inferior, al crecer la renta disminuirán el
...
Menor presupuesto policial: la oferta de drogas se incrementa al tener
los traficantes menos dificultades para vender droga en la calle.
#+xxx: fig fig-ans-probl-2_1004-drugs1-*.pdf

Recortes en educación: la demanda aumenta al ser los compradores
potenciales menos conscientes de los peligros asociados al consumo de
drogas.
...
si el precio aumenta o disminuye es posible determinar cuál de las dos
...
El precio baja si el cambio en la oferta es relativamente menor que el
cambio en la demanda.
#+xxx: fig fig-ans-probl-2_1004-inferior1-*.pdf

El precio sube si el cambio en la oferta es relativamente mayor que el
cambio en la demanda.
...
de semana: la curva de oferta no cambia.  Pero la demanda entre semana
es muy diferente a la demanda de fin de semana.
#+latex: \vspace*{1ex}
...
#+xxx: fig fig-ans-probl-2_1004-week-days-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig fig-ans-probl-2_1004-weekend-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
En fin de semana la demanda de habitaciones por motivos de turismo y
ocio es mayoritaria. Este tipo de viajeros tiene una menor disposición
a pagar y si el precio de las habitaciones es muy elevado, buscará
...
a) La oferta mundial de café se contrae y la demanda no se ve
...
b) El café y el té son bienes sustitutivos y un alza del precio del
