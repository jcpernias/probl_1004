...
#+begin_src latex :tangle fig-ans-probl-8_1004-ex4-pmgl.tex :noweb no
...
#+begin_src latex :tangle fig-ans-probl-8_1004-ex4-fprod.tex :noweb no
...
** Constant returns
  ...
  #+begin_src latex :tangle fig-probl-8_1004-ex8-const-returns.tex
...
** 8.9 Increasing returns

  #+begin_src latex :tangle fig-probl-8_1004-ex8-incr-returns.tex
    \begin{tikzpicture}<<ex8:xy-scale>>
...
* 8.11 Average and marginal product

#+begin_src latex :tangle fig-probl-8_1004-ex11-pmel.tex
