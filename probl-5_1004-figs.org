...
#+begin_src latex :noweb-ref ex5.1:budget-no-tax
...
#+begin_src latex :noweb-ref ex5.1:budget-sales-tax
  \draw[curve, very thick]
...
#+begin_src latex :noweb-ref ex5.1:budget-income-tax
  \draw[curve, very thick]
...
#+begin_src latex :tangle fig-ans-probl-5_1004-discount1.tex
