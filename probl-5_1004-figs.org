...
* 5.1 Budget line and taxes


** Sales tax

#+begin_src latex :tangle fig-probl-5_1004-budget-tax1.tex
...
#+begin_src latex :tangle fig-probl-5_1004-budget-tax2.tex
  \begin{tikzpicture}<<ex1:xy-scale>>
...
* 5.2 Budget line and promotions


** Initial situation

#+begin_src latex :tangle fig-probl-5_1004-budget1.tex :noweb no
...
#+begin_src latex :tangle fig-probl-5_1004-budget2.tex :noweb no
  \begin{tikzpicture}[xscale = 0.3, yscale = 0.3]
...
* 5.3 Neutral goods and bads


** Neutral good

#+begin_src latex :tangle fig-probl-5_1004-neutral.tex
...
#+begin_src latex :tangle fig-probl-5_1004-bad.tex
  \begin{tikzpicture}<<ex3:xy-scale>>
...
#+begin_src latex :tangle fig-probl-5_1004-choice.tex :noweb no
...
#+begin_src latex :tangle fig-probl-5_1004-walnut1.tex
...
#+begin_src latex :tangle fig-probl-5_1004-walnut2.tex
  \begin{tikzpicture}<<ex8:xy-scale>>
    \draw[help lines]
...
#+begin_src latex :tangle fig-probl-5_1004-walnut3.tex
  \begin{tikzpicture}<<ex8:xy-scale>>
    \draw[help lines]
      (1.5, 4) --
...
#+begin_src latex :tangle fig-probl-5_1004-walnut4.tex
  \begin{tikzpicture}<<ex8:xy-scale>>
    \draw[help lines]
      (0, 4.2) node[left] {$42$} -|
...
* 5.9 Quantity discount


** Initial situation

#+begin_src latex :tangle fig-probl-5_1004-discount1.tex
...
* 5.10 Corner solitions and rationing


** Initial situation

#+begin_src latex :tangle fig-probl-5_1004-corner1.tex
...
#+begin_src latex :tangle fig-probl-5_1004-corner2.tex
  \begin{tikzpicture}<<ex10:xy-scale>>
...
* 5.12 Perfect complements


** Indiference curves

#+begin_src latex :tangle fig-probl-5_1004-compl1.tex
...
#+begin_src latex :tangle fig-probl-5_1004-compl2.tex
  \begin{tikzpicture}<<ex12:xy-scale>>
