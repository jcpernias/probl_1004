...
#+xxx: fig file:fig-probl-4_1004-price-controls-*.pdf
...
a)
   ...
   #+xxx: fig file:fig-ans-probl-4_1004-price-controls-a-*.pdf
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-price-controls-b-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
c)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-price-controls-c-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
d)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-price-controls-d-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-min-price-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-4_1004-sugar-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
a) La curva de demanda es:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-eq1-*.pdf
   #+ATTR_LATEX: :options [t]{0.50\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b) La nueva curva de demanda es:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-eq2-*.pdf
   #+ATTR_LATEX: :options [t]{0.50\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b) La curva de oferta después del impuesto es:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-tax-sellers-*.pdf
...
d) La curva de demanda después del impuesto es:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-tax-buyers-*.pdf
   #+ATTR_LATEX: :options [t]{0.4\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Después del impuesto:
...
b) Cuando se introduce la subvención la curva de demanda es:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-4_1004-subsidy2-*.pdf
   #+ATTR_LATEX: :options [t]{0.4\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
