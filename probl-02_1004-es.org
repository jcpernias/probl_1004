...
a) La demanda de mercado es la suma de las cantidades demandadas
   ...
   #+xxx: fig file:fig-ans-probl-2_1004-market-eq-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
#+xxx: fig file:fig-ans-probl-2_1004-market-demand-*.pdf
...
a)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-cars1-*.pdf
...
b) La cantidad demandada aumenta un 20% para cada posible precio:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-cars2-*.pdf
   #+ATTR_LATEX: :options [t]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Equilibrio:
...
a)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-comp1-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Equilibrio:
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-comp2-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
c) No es posible determinar qué ocurrirá con el precio y la cantidad
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-comp3-*.pdf
   #+begin_center
   Bien normal
   #+end_center
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-comp4-*.pdf
   #+begin_center
   Bien inferior
   #+end_center
   #+xxx: endcol
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-2_1004-drugs1-*.pdf
#+begin_export latex
\begin{center}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-2_1004-drugs2-*.pdf
#+begin_export latex
\begin{center}
  \begin{minipage}{0.9\linewidth}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-2_1004-inferior1-*.pdf
#+begin_export latex
\begin{center}
  \begin{minipage}{0.9\linewidth}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-2_1004-inferior2-*.pdf
#+begin_export latex
\begin{center}
  \begin{minipage}{0.9\linewidth}
...
a)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-coffee-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-tea-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
a)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-scooters-a-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-scooters-b-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
c)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-scooters-c-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
d)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-2_1004-scooters-d-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
