...
#+begin_src latex :tangle fig-probl-6_1004-crc2.tex
...
#+begin_src latex :tangle fig-probl-6_1004-crc3.tex
  \begin{tikzpicture}<<ex3:xy-scale-small>>
...
#+begin_src latex :tangle fig-probl-6_1004-cpc1.tex :noweb no
...
#+begin_src latex :tangle fig-probl-6_1004-cpc2.tex :noweb no
...
#+begin_src latex :tangle fig-probl-6_1004-compl.tex :noweb no
...
#+begin_src latex :tangle fig-probl-6_1004-corner.tex :noweb no
