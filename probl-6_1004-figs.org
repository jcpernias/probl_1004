...
* 6.8 Individual and market demands
...
* 6.9 Neutral goods and perfect substitutes

** Choice

#+begin_src latex :tangle fig-ans-probl-6_1004-choice-neutral.tex
  \begin{tikzpicture}[xscale=0.0375, yscale=0.067]
...
#+begin_src latex :tangle fig-ans-probl-6_1004-demand-neutral.tex
  \begin{tikzpicture}[xscale=0.0375, yscale=0.3]
    \coordinate (Xaxis) at (80, 0);
...
* COMMENT 6.11 Income and substitution effects
...
* COMMENT 6.8 Income and substitution effects: Perfect complements
...
* COMMENT Corner solution and demand curve
:PROPERTIES:
