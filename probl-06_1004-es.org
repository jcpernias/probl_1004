...
a)
   ...
   #+xxx: col
   #+latex: \vspace{1ex}
   La cesta $C$ contiene más manzanas y naranjas que la cesta $B$: el
   supuesto de no saturación implica que $C \succ B$. Dado que $B \sim A$
   y las preferencias son transitivas, concluimos que $C \succ A$.
   #+xxx: endcol
...
b)
   ...
   #+xxx: col
   #+latex: \vspace{1ex}
   Si las preferencias son (estrictamente) convexas, todas las cestas
   situadas en el segmento $\overline{AB}$ (como $M$) serán preferidas
   a $A$: $M \succ A$. Por otro lado, $D$ contiene más naranjas que
   $M$ por lo que $D \succ M$. Finalmente, por la transitividad de las
   preferencias, deducimos que $D \succ A$.
   #+xxx: endcol
