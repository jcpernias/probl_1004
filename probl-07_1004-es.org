...
#+xxx: fig file:fig-ans-probl-5_1004-choice-*.pdf
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-5_1004-corner3-*.pdf
...
a) Relación marginal de sustitución:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-walnut1-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Recta presupuestaria:
...
b) /Subvención/: la restricción presupuestaria tiene dos tramos. Si el
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-walnut2-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Cesta óptima:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-walnut3-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Cesta óptima:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-walnut4-*.pdf
   #+ATTR_LATEX: :options [t]{0.5\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Recta presupuestaria:
...
b) Si se hace socio, el alquiler es más barato pero deberá pagar la
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-tennis-*.pdf
...
a) Al tratar de obtener una solución interior se llega a $X = 325$ e
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-corner1-*.pdf
   #+ATTR_LATEX: :options [t]{0.48\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
   Solución de esquina:
...
b) Cuando el consumo de $X$ se raciona, el consumidor no puede elegir
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-corner2-*.pdf
   #+ATTR_LATEX: :options [t]{0.48\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
a) Para Rocío la leche y los cereales son complementos perfectos. Su
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-compl1-*.pdf
   #+ATTR_LATEX: :options [t]{0.48\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
...
b) La recta presupuestaria de Rocío es:
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-5_1004-compl2-*.pdf
   #+ATTR_LATEX: :options [t]{0.48\linewidth}
   #+xxx: col
   #+latex: \vspace{1ex}
