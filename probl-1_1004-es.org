...
Excluimos el punto $C$ porque el coste de oportunidad no está definido
para combinaciones de producción inaccesibles.

En los puntos ineficientes, como el $B$, el coste de oportunidad
es $0$.  En los puntos sobre la frontera el coste de oportunidad del
pescado es positivo y es mayor cuanto más pronunciada es la pendiente
de la frontera.

Por tanto, si se ordenan las opciones factibles de mayor a menor coste
