...
Se cumple la ley de rendimientos decrecientes del factor trabajo.  La
situación correspondiente a la última fila de la tabla, contratar 6
trabajadores, no es técnicamente eficiente: el producto marginal del sexto tyrabajador es negativo.
