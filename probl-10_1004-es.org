...
c) /Maximización del \PMgL/: La derivada del producto marginal es:
   ...
   #+xxx: fig file:fig-ans-probl-8_1004-pmgl-*.pdf
   #+ATTR_LATEX: :options [b]{0.45\linewidth}
   #+xxx: col
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-fprod-*.pdf
   #+xxx: endcol
...
a)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-total-a-*.pdf
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-total-b-*.pdf
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-total-c-*.pdf
...
b)
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-marginal-a-*.pdf
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-marginal-b-*.pdf
   ...
   #+latex: \vspace{0pt}
   #+ATTR_LATEX: :center nil
   #+xxx: fig file:fig-ans-probl-8_1004-marginal-c-*.pdf
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-8_1004-pmel-a-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-8_1004-pmel-b-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-8_1004-pmel-c-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-8_1004-pmel-d-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
#+latex: \vspace{0pt}
#+ATTR_LATEX: :center nil
#+xxx: fig file:fig-ans-probl-8_1004-pmel-decr-*.pdf
#+ATTR_LATEX: :options [t]{0.5\linewidth}
#+xxx: col
#+latex: \vspace{1ex}
...
a)
   ...
   #+xxx: col
   #+latex: \vspace{0pt}
   #+xxx: fig file:fig-ans-probl-8_1004-const-returns-a-*.pdf
   #+xxx: endcol
   #+latex: \vspace*{1ex}
...
a)
   ...
   #+xxx: col
   #+latex: \vspace{0pt}
   #+xxx: fig file:fig-ans-probl-8_1004-incr-returns-a-*.pdf
   #+xxx: endcol
   #+latex: \vspace*{1ex}
