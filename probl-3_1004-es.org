...
\]
#+end_export
Dividiendo el gasto en alimentos por su precio obtenemos las unidades
de alimentos que inicialmente compra Ana durante un año: $Q_1=
\num{5000} / 2 = \num{2500}$. Después de recibir la beca, el consumo
de alimentos será un 2% superior: $Q_2 = 1.02 \times \num{2500} =
\num{2550}$ unidades.
