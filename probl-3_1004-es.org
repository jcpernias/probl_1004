...
a) Si el precio del gas aumenta desde \price[\kWh]{0.054} hasta
   \price[\kWh]{0.066}, ¿qué ocurrirá con la cantidad demandada a corto
   plazo? ¿Y a largo plazo? (Use la fórmula del punto medio)
...
disminuye un 30%, mientras que los ingresos de los vendedores aumentan
en un 10%. ¿Es elástica o inelástica la demanda?  Calcule el valor de
