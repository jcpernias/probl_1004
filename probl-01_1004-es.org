...
a) Representamos la FPP con los valores contenidos en las columnas $A$
   ...
   #+xxx: fig file:fig-ans-probl-1_1004-ppf-shift-a-*.pdf
...
c) Una mejora organizativa hace que, usando los mismos recursos, la
   ...
   #+xxx: fig file:fig-ans-probl-1_1004-ppf-shift-c-*.pdf
...
d) Calculamos las combinaciones de producción eficientes cuando sólo
   ...
   #+xxx: fig file:fig-ans-probl-1_1004-ppf-shift-d-*.pdf
...
a) Frontera de posibilidades de producción:
   #+xxx: fig file:fig-ans-probl-1_1004-ppf-oc1-*.pdf
...
a) Frontera de posibilidades de producción:
   ...
   #+xxx: fig file:fig-ans-probl-1_1004-ppf-lin-*.pdf
...
#+xxx: fig file:fig-probl-1_1004-ppf-*.pdf
...
#+xxx: fig file:fig-probl-1_1004-ppf-multi-*.pdf
