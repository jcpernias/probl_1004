...
* Ex. 1: Short-run curves
  ...
  #+begin_src latex :tangle fig-probl-6_1004-short-curves1.tex :noweb no
  ...
  #+begin_src latex :tangle fig-probl-6_1004-short-curves2.tex :noweb no
...
* Ex. 4: Long-run choice
  ...
  #+begin_src latex :tangle fig-probl-6_1004-choice.tex :noweb no
  ...
  #+begin_src latex :tangle fig-probl-6_1004-choice2.tex :noweb no
...
* Ex. 8: Long-run marginal and average cost curves
  ...
  #+begin_src latex :tangle fig-probl-6_1004-cmg-cme-long.tex :noweb no
...
* Ex.9: Short-run and long-run cost curves
  ...
  #+begin_src latex :tangle fig-probl-6_1004-short-long.tex :noweb no
...
* Ex. 10: Expansion paths
  ...
  #+begin_src latex :tangle fig-probl-6_1004-expansion.tex :noweb no
  ...
  #+begin_src latex :tangle fig-probl-6_1004-expansion2.tex :noweb no
...
* Ex. 12: Envelop
  ...
  #+begin_src latex :tangle fig-probl-6_1004-envelop.tex :noweb no
